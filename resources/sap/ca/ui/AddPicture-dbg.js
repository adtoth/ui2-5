 ...
 * <li>{@link #getItemSize itemSize} : sap.ui.core.CSSSize (default: '62px')</li></ul>
 * </li>
 * <li>Aggregations
 * <ul>
...
sap.ui.core.Control.extend("sap.ca.ui.AddPicture", { metadata : {
	...
	properties : {
		...
		"itemSize" : {type : "sap.ui.core.CSSSize", group : "Appearance", defaultValue : '62px'}
	},
	aggregations : {
 ...
 *
 * @return {sap.ui.core.CSSSize} the value of property <code>itemSize</code>
 * @public
 ...
 * Default value is <code>62px</code> 
 *
 * @param {sap.ui.core.CSSSize} sItemSize  new value for property <code>itemSize</code>
 * @return {sap.ca.ui.AddPicture} <code>this</code> to allow method chaining
 * @public
 ...
 * @private
 */
sap.ca.ui.AddPicture.prototype._clickCaptureInput = function () {
...
sap.ca.ui.AddPicture.prototype._createAndAddPictureItem = function (imageSource, filename) {
    ...
    var oPictureItem = new sap.ca.ui.PictureItem({ status : sap.ca.ui.PictureItem.STATUS.ADD, 
    												...
    												width: this.getItemSize(), height: this.getItemSize() });
...
sap.ca.ui.AddPicture.prototype._createAndAddPictureItemFromFile = function (file) {
    ...
    var oPictureItem = new sap.ca.ui.PictureItem({ status : sap.ca.ui.PictureItem.STATUS.ADD, name : file.name, width: this.getItemSize(), height: this.getItemSize() });
