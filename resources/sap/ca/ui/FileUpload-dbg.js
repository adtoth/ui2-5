 ...
 * <li>{@link #getShowAttachmentsLabelInEditMode showAttachmentsLabelInEditMode} : boolean (default: true)</li></ul>
 * </li>
 * <li>Aggregations
 * <ul>
 ...
 * <li>{@link sap.ca.ui.FileUpload#event:beforeUploadFile beforeUploadFile} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li></ul>
 * </li>
 * </ul> 
...
sap.ca.ui.FileUpload.M_EVENTS = {'deleteFile':'deleteFile','renameFile':'renameFile','uploadFile':'uploadFile','fileUploadFailed':'fileUploadFailed','beforeUploadFile':'beforeUploadFile'};
...
/**
 * Fired when a file deletion event occurs typically by clicking a the delete icon. The file descripter json for the file to be deleted is passed in the event data 
 *
...
sap.ca.ui.FileUpload.prototype.init = function() {
    ...
    this._sUsrAg = navigator.userAgent;
    ...
    this._sUploadingText = this._oBundle.getText("FileUploader.uploading");
    this._sComplete = this._oBundle.getText("FileUploader.complete");
    ...
    this._oProgressLabel = new sap.m.Label(this.getId() + "-progress", {
        text : {
            ...
            formatter : function(value) {
                ...
                var sValue = oControl._sUploadingText + ": " + 
                	percent + "% " + oControl._sComplete;
                return sValue;
            }
        },
    ...
    var oDateSizeHL = new sap.ui.layout.HorizontalLayout(this.getId() + "-ba-datesizelayout", {
...
sap.ca.ui.FileUpload.prototype.onAfterRendering = function() {
    ...
    // for IE, we need to first send the multipart/form request to the base64
    // encoder service
    if (this._isIE() && !this.getUseMultipart()) {
...
sap.ca.ui.FileUpload.prototype.removeFile = function(fileId) {
    ...
    this.commitPendingRenames();  //update model with any changes to filenames which have not been handled before delete
};
...
sap.ca.ui.FileUpload.prototype.commitFileUpload = function(data) {
    var uploadedFileName = data[this.getFileName()];
    //  format the size
...
sap.ca.ui.FileUpload.prototype._isIE = function() {
    return this._sUsrAg.indexOf("MSIE") > -1;
};
...
sap.ca.ui.FileUpload.prototype.uploadDone = function(e, data) {
    ...
    try {
        //for IE, we need to build a second request and send the base64 encoded string to server
        if (this._isIE()) {
