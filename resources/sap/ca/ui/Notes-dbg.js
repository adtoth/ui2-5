...
sap.ca.ui.Notes.prototype.init = function() {
    ...
    this._oTextArea.attachLiveChange(this.liveChangeMonitor);
...
{
    if (oEvent.mParameters.newValue.length === _maxLength)
    {
        var messageText = sap.ca.ui.utils.resourcebundle.getText("TextOverlimit", [_maxLength]);
