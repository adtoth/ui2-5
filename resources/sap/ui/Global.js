 ...
 */
if(window.OpenAjax&&window.OpenAjax.hub){OpenAjax.hub.registerLibrary("sap","http://www.sap.com/","0.1",{})}jQuery.sap.declare("sap.ui.Global");jQuery.sap.require("jquery.sap.dom");if(typeof window.sap!=="object"&&typeof window.sap!=="function"){window.sap={}}if(typeof window.sap.ui!=="object"){window.sap.ui={}}sap.ui=jQuery.extend(sap.ui,{version:"1.16.3",buildinfo:{lastchange:"0e8f89cea3a9f30c03203eb5f053b9f1d51e76a0",buildtime:"201310151016"}});
